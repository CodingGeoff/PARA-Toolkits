...
def format_size(size_bytes):
    ...
    if size_kb < 1024: return f"{size_kb:.2f} KB"
    size_mb = size_kb / 1024
    if size_mb < 1024: return f"{size_mb:.2f} MB"
    size_gb = size_mb / 1024
    if size_gb < 1024: return f"{size_gb:.2f} GB"
...
class HashManager:
    ...
    def prune_cache(self, valid_paths_set):
        ...
        if paths_to_delete:
            ...
            self.connection.commit()
            print(f"Pruned {len(paths_to_delete)} stale entries from hash cache.")
...
# --- Your ParaFileManager class definition starts below this line ---
...
# --- In ParaFileManager.__init__, add this line ---
        ...
        # ... (most of __init__ is unchanged) ...
        self.operating_mode = "para" # Default
        # ...
        # self.init_ui()
...
#     def init_ui(self):
#         # ...
#         # Get a reference to the widget containing the drop frames
#         self.drop_frames_widget = self._create_drop_frames()
#         v_splitter.addWidget(self.drop_frames_widget)
#         # ...

#     def reload_configuration(self):
#         # ... (implement the mode-switching logic from previous response) ...
#         # This will set self.base_dir and self.operating_mode
#         # and then call update_ui_from_config
